...
class Posts::CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  # test "should create comment" do
  #   assert_difference("PostComment.count") do
  #     post_comment = post.post_comments.create(content: "Test comment", post_id: @post.id, user_id: @user.id, parent_id: nil)
  ...
  #   patch post_comment_url(@comment), params: { comment: { body: @comment.body, post_id: @comment.post_id, user_id: @comment.user_id } }
